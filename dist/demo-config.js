...
export class DemoMode {
    static isEnabled() {
        ...
        const noCreds = !process.env.LODESTAR_USERNAME || !process.env.LODESTAR_PASSWORD;
    ...
    static getMockResponse(endpoint, args) {
    ...
    static getMockClosingCosts(args) {
        ...
        return {
            ...
            title_insurance: {
                "Lender's Title Policy": this.calculateTitleInsurance(loanAmount, 'lender'),
                ...
                'Reissue Credit': args.purpose === '04'
            ...
            disclaimer: 'DEMO MODE - These are sample calculations for testing purposes only',
        };
    }
    static calculateTitleInsurance(amount, type) {
    ...
    static calculateTotalFees(args, loanAmount, purchasePrice) {
        let total = 0;
    ...
    static getMockPropertyTax(args) {
        const purchasePrice = args.purchase_price || 400000;
    ...
    static getMockEndorsements(args) {
        const endorsements = [
            {
                id: 'ALTA-4',
        ...
        return {
            ...
            total_if_all_selected: endorsements.reduce((sum, e) => sum + e.premium, 0),
            disclaimer: 'DEMO MODE - Sample endorsements list',
        };
    }
    static getMockSubAgents(args) {
        return {
            success: true,
            demo_mode: true,
            location: {
    ...
    static getMockGeocodeCheck(args) {
    ...
    static getMockAppraisalModifiers(args) {
